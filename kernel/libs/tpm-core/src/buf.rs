...
impl<const N: usize> TpmBuf<N> {
    ...
    pub fn append(&mut self, src: &[u8]) {
        ...
        let mut i: usize = 0;
        while i < src.len() {
            let b: u8 = *crate::slice_index_get(src, i);
            self.data[start + i] = b;
            i = i + 1;
        }
    ...
    pub fn read_u8(&mut self, offset: &mut usize) -> u8 {
        ...
        let v = *crate::array_index_get(&self.data, *offset);
        *offset = *offset + 1;
        v
    }
    /// 对应 `tpm_buf_read_u16()`。
    pub fn read_u16(&mut self, offset: &mut usize) -> u16 {
        ...
        let o = *offset;
        let b0 = *crate::array_index_get(&self.data, o);
        let b1 = *crate::array_index_get(&self.data, o + 1);
        *offset = o + 2;
        be16_of_exec(b0, b1)
    }
    /// 对应 `tpm_buf_read_u32()`。
    pub fn read_u32(&mut self, offset: &mut usize) -> u32 {
        ...
        let b0 = *crate::array_index_get(&self.data, o);
        let b1 = *crate::array_index_get(&self.data, o + 1);
        let b2 = *crate::array_index_get(&self.data, o + 2);
        let b3 = *crate::array_index_get(&self.data, o + 3);
        *offset = o + 4;
    ...
    pub fn as_wire(&self) -> &[u8] {
        crate::slice_subrange(crate::array_as_slice(&self.data), 0, self.length)
    }
}
